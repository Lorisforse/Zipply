...
import 'package:ziply_app/presentation/mobile/map/widgets/route_preview_panel.dart';
...
// Widget del cluster "prenotazione di gruppo" (UT.16), estratti in un file parte
// della stessa libreria per snellire map_screen mantenendone l'accesso privato.
      ...
      children: [
        ...
        if (_routing)
          const Positioned(
            ...
            right: 0,
            top: 70,
            child: Center(child: const RoutingChip()),
          ),
