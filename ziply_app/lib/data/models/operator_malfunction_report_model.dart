...
/// posizione) restituiti dal backend su GET /operator/malfunction-reports.
class OperatorMalfunctionReportModel {
  final String id;
  ...
  const OperatorMalfunctionReportModel({
    required this.id,
  ...
  factory OperatorMalfunctionReportModel.fromJson(Map<String, dynamic> json) {
    return OperatorMalfunctionReportModel(
